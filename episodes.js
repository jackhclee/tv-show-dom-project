...
async function initLocalEpisodesCache(showId) {
  const gotEndpoint = `https://api.tvmaze.com/shows/${showId}/episodes`;

  // check if local cache is present
  let cacheId = "S" + showId;
  if (localEpisodesCache[cacheId] === null || localEpisodesCache[cacheId] === undefined) {
...
function fetchEpisodes(showId) {
  ...
  if (localEpisodesCache["S"+ showId] != null) {
    console.log(`Returning show Episodes Data from localEpisodesCache ${showId}`);
    return Promise.resolve(localEpisodesCache["S"+ showId]);
  }
